package com.FileServer;/*package com.nmbox.common;*/
...
public class Tools2 {
	...
	*/
	...
	public static Properties loadProperties(String configFile) {
		...
		try {
			p.load(Tools2.class.getClassLoader().getResourceAsStream(configFile));
		} catch (Exception e) {
		}
		try {
	...
	public static void main(String[] args) throws Exception {
		...
		KeyPair kp = Tools2.generateRSAKeyPair(2048);
		byte[] result = Tools2.encryptByRSA(test, kp.getPrivate());
